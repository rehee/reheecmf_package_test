...
{
    internal partial class MyUserEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "ReheeCmfPackageTest.Data.MyUser",
                typeof(MyUser),
                baseEntityType);
            ...
            var avatar = runtimeEntityType.AddProperty(
                "Avatar",
                typeof(string),
                propertyInfo: typeof(ReheeCmfBaseUser).GetProperty("Avatar", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(ReheeCmfBaseUser).GetField("<Avatar>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);
            ...
            var thisRoles = runtimeEntityType.AddProperty(
                "ThisRoles",
                typeof(string),
                propertyInfo: typeof(MyUser).GetProperty("ThisRoles", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);
            thisRoles.AddAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.None);
